namespace n_language
{
    ...
    public class Clanguage
    {
		...
		//copyright
		public static string ls_copyright;
		public static string ls_company_name;
		public static string ls_count_spillover;
		//Public 
		...
		public static string ls_device_name;
        ...
        public static void sel_english()
        {
			...
			Clanguage.ls_copyright = "Copyright (C) 2018/06/22 - Present , Red-Arrow Intelligent Technology Co. Ltd.It can be used after ten seconds";
			Clanguage.ls_company_name = "Red-Arrow Intelligent Technology Co. Ltd";
			Clanguage.ls_count_spillover = "Test count spillover";
			...
			Clanguage.ls_device_name = "DeviceName";
        ...
        public static void sel_chinese()
        {
			...
			Clanguage.ls_copyright= "版权所有(C),2018/06/22-至今, 赤箭智能科技有限公司,等待10秒后可正常使用.";
			Clanguage.ls_company_name = "赤箭智能科技有限公司";
			Clanguage.ls_count_spillover = "版权(C)所有您的测试数量已超上限，请联系供应商获取授权";
